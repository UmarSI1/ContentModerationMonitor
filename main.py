...
from general import *
#from harm_specific import *
#from candhspecific import *
...
def main():
    ...
    # Dropdown for selecting a specific company
    # with company_col:
    #     st.subheader("Select a Specific Company:")
    #     company_options = [None] + list(pivot_df['platform_name'].unique())
    ...
    if selected_option == "General Data":
        ...
        figtest = sum_harm(data_ACC)
        fig0 = plot_company_dataxxz(data_ACC)
        fig0two = plot_company_dataxxz_normalized(data_ACC)
        fig1 = plot_content_type_totals(data_ACC)
        fig2 = plot_moderation_action_totals(data_ACC)
        fig3 = plot_automation_status_totals(data_ACC)
        fig4 = plot_harm_totals_per_company(data_ACC)
        fig5 = plot_content_type_totals_per_company(data_ACC)
        fig6 = plot_automation_status_table_general(data_ACC)
        fig7 = plot_normalized_automation_status(data_ACC)
        fig8 = plot_harm_content_type(data_ACC)
        fig9 = plot_harm_content_type_normalized(data_ACC)
        fig10 = plot_harm_automation_status(data_ACC)
        fig10two = plot_harm_automation_status_two(data_ACC)
        fig11 = plot_content_type_automation_status(data_ACC)
        fig11two = plot_content_type_automation_status_two(data_ACC)

        #put fig 12 in own column
        fig12 = sum_reports_per_harm_per_moderation_action(data_ACC)
        fig13 = generate_content_type_moderation_action_figure(data_ACC)
        fig14 = generate_moderation_action_automation_status_figure(data_ACC)
        fig15 = sum_reports_per_moderation_action_per_company(data_ACC)
      ...
      #  Your plot generation code (assuming fig0 is defined somewhere)
        ...
        figtest = sum_harm3(data_ACC, selected_company,  selected_harm)
        fig0 = plot_company_dataxxz3(data_ACC, selected_company,  selected_harm)
        fig0two = plot_company_dataxxz3_normalized(data_ACC, selected_company,  selected_harm)
        fig1 = plot_content_type_totals3(data_ACC, selected_company,  selected_harm)
        fig2 = plot_moderation_action_totals3(data_ACC, selected_company,  selected_harm)
        fig3 = plot_automation_status_totals3(data_ACC, selected_company,  selected_harm)
        fig4 = plot_harm_totals_per_company3(data_ACC, selected_company,  selected_harm)
        fig5 = plot_content_type_totals_per_company3(data_ACC, selected_company,  selected_harm)
        fig6 = plot_automation_status_table_general3(data_ACC, selected_company,  selected_harm)
        fig7 = plot_normalized_automation_status3(data_ACC, selected_company,  selected_harm)
        fig8 = plot_harm_content_type3(data_ACC, selected_company,  selected_harm)
        fig9 = plot_harm_content_type3_normalized(data_ACC, selected_company,  selected_harm)
        fig9two = plot_harm_content_type_normalized3(data_ACC, selected_company,  selected_harm)
        fig10 = plot_harm_automation_status3(data_ACC, selected_company,  selected_harm)
        fig10two = plot_harm_automation_status3_normalized(data_ACC, selected_company,  selected_harm)
        fig11 = plot_content_type_automation_status3(data_ACC, selected_company,  selected_harm)
        fig11two = plot_content_type_automation_status3_normalized(data_ACC, selected_company,  selected_harm)
       # fig12 = sum_reports_per_harm_per_moderation_action3(data_ACC, selected_company,  selected_harm)
       # fig13 = generate_content_type_moderation_action_figure3(data_ACC, selected_company,  selected_harm)
        fig14 = generate_moderation_action_automation_status_figure3(data_ACC, selected_company,  selected_harm)
        fig15 = sum_reports_per_moderation_action_per_company3(data_ACC, selected_company,  selected_harm)
    ...
    #fix last graph and rename expander titles
        ...
        figtest = sum_harm1(data_ACC, selected_company)
        fig0 = plot_company_dataxxz1(data_ACC, selected_company)
        fig0two = plot_company_dataxxz1_normalized(data_ACC, selected_company)
        fig1 = plot_content_type_totals1(data_ACC, selected_company)
        fig2 = plot_moderation_action_totals1(data_ACC, selected_company)
        fig3 = plot_automation_status_totals1(data_ACC, selected_company)
        fig4 = plot_harm_totals_per_company1(data_ACC, selected_company)
        fig5 = plot_content_type_totals_per_company1(data_ACC, selected_company)
        fig6 = plot_automation_status_table_general1(data_ACC, selected_company)
        fig7 = plot_normalized_automation_status1(data_ACC, selected_company)
        fig8 = plot_harm_content_type1(data_ACC, selected_company)
        fig9 = plot_harm_content_type_1(data_ACC, selected_company)
        fig9two = plot_harm_content_type_normalized1(data_ACC, selected_company)
        fig10 = plot_harm_automation_status1(data_ACC, selected_company)
        fig10two = plot_harm_automation_status1_normalized(data_ACC, selected_company)
        fig11 = plot_content_type_automation_status1(data_ACC, selected_company)
        fig11two = plot_content_type_automation_status1_normalized(data_ACC, selected_company)
        #fig12 = sum_reports_per_harm_per_moderation_action1(data_ACC, selected_company)
        fig13 = generate_content_type_moderation_action_figure1(data_ACC, selected_company)
        fig14 = generate_moderation_action_automation_status_figure1(data_ACC, selected_company)
        fig15 = sum_reports_per_moderation_action_per_company1(data_ACC, selected_company)
      ...
      #  Your plot generation code (assuming fig0 is defined somewhere)
        ...
        figtest = sum_harm2(data_ACC, selected_harm)
        fig0 = plot_company_dataxxz2(data_ACC, selected_harm)
        fig0two = plot_company_dataxxz2_normalized(data_ACC, selected_harm)
        fig1 = plot_content_type_totals2(data_ACC, selected_harm)
        fig2 = plot_moderation_action_totals2(data_ACC, selected_harm)
        fig3 = plot_automation_status_totals2(data_ACC, selected_harm)
        fig4 = plot_harm_totals_per_company2(data_ACC, selected_harm)
        fig5 = plot_content_type_totals_per_company2(data_ACC, selected_harm)
        fig6 = plot_automation_status_table_general2(data_ACC, selected_harm)
        fig7 = plot_normalized_automation_status2(data_ACC, selected_harm)
        fig8 = plot_harm_content_type2(data_ACC, selected_harm)
        fig9 = plot_harm_content_type_normalized2(data_ACC, selected_harm)
        fig10 = plot_harm_automation_status2(data_ACC, selected_harm)
        fig10two = plot_harm_automation_status2_normalized(data_ACC, selected_harm)
        fig11 = plot_content_type_automation_status2(data_ACC, selected_harm)
        fig11two = plot_content_type_automation_status2_normalized(data_ACC, selected_harm)
        fig12 = sum_reports_per_harm_per_moderation_action2(data_ACC, selected_harm)
        fig13 = generate_content_type_moderation_action_figure2(data_ACC, selected_harm)
        fig14 = generate_moderation_action_automation_status_figure2(data_ACC, selected_harm)
        fig15 = sum_reports_per_moderation_action_per_company2(data_ACC, selected_harm)
