...
def plot_company_dataxxz(data):
    ...
    company_data['Company'].append('Total')  # Append 'Total' label
    company_data['N# Actions'].append(total_sum_all_companies)  # Append the total sum
...
def plot_harm_totals_per_company(data):
    ...
    for company, harms in harm_totals_per_company.items():
        ...
        data_for_df['Company'].append(company)
        data_for_df['N# Actions'].append(total_harm_totals[company])
    ...
    table.scale(6, 6)  # Increase cell height (adjust as needed)

    # Set font size
    table.auto_set_font_size(False)
    table.set_fontsize(25)  # Adjust font size as needed
...
def sum_reports_per_moderation_action_per_company(data):
    ...
    for company, moderation_actions in moderation_action_totals_per_company.items():
        ...
        data_for_df['N# Actions'].append(total_moderation_action_totals_per_company[company])
